...
class SearchPage:
    def __init__(self, driver):
        ...
        self.result_of_search_text_xpath = '//android.widget.TextView[@resource-id="org.wikipedia:id/page_list_item_title" and @text="SoftServe"]'

    def enter_text(self):
        element = WebDriverWait(self.driver, 20).until(
            EC.presence_of_element_located((By.ID, self.search_text_id))
        )
        element.send_keys("SoftServe")
